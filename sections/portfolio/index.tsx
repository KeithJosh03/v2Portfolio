...
export const PortfolioComponent = () => {
  return (
    <section className={`${poppins.className} min-h-screen`}>
        <div className='w-auto flex flex-col text-center content-center gap-y-4'>
            <h1 className='text-PrimaryCol text-6xl font-extrabold text-left lg:text-center'>PORTFOLIO</h1>
            <div className='h-fit rounded-2xl flex flex-row bg-avatarBG shadow-2xl p-4'>
                <div className='basis-5/12 text-left p-6 flex flex-col gap-4'>
                    ...
                    <p className='text-sm font-normal text-ThirdCol text-left'>PSO for small local Pharmacies Use, for effiecent customer services and receipt for assure good quality drugs.</p>
                </div>
                <div className='basis-7/12 content-center p-2'>
                    ...
                    <div className='h-1/5 flex flex-row gap-2 justify-left items-center'>
                        <div className='text-xs font-normal bg-stackBG text-SecondaryCol p-2 rounded-xl text-center'>
                            <span>Bootstrap</span>
                        </div>
                        <div className='text-xs font-normal bg-stackBG text-SecondaryCol p-2 rounded-xl text-center'>
            ...
            <div className='h-1/3 rounded-2xl flex flex-row bg-avatarBG shadow-2xl p-4'>
                <div className='basis-5/12 text-left p-6 flex flex-col gap-4'>
                    ...
                    <p className='text-sm font-normal text-ThirdCol text-left'>Honey is a browser extension that automatically finds and applies coupon codes at checkout, helping users save money on their online purchases.</p>
                </div>
                <div className='basis-7/12 content-center p-2'>
                <div className='h-4/5'>
            ...
            <div className='h-1/3 rounded-2xl flex flex-row bg-avatarBG shadow-2xl p-4'>
                <div className='basis-5/12 text-left p-6 flex flex-col gap-4'>
                    ...
                    <p className='text-sm font-normal text-ThirdCol text-left'>Developed and maintained a login and HR system for company employees.
                    </p>
                </div>
                <div className='basis-7/12 content-center p-2'>
                    <div className='h-4/5'>
