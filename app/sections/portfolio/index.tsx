...
export const PortfolioComponent = () => {
  ...
  return (
    <section className={`${press.className} min-h-screen col-span-12 flex flex-col container gap-10`}>
      ...
      <div className='container grid grid-cols-2 gap-4'>
        <Link href='/portfolio/project'>
          ...
          >
          <h1 className='text-4xl font-extrabold text-PrimaryCol absolute left-10 top-10 group-hover:text-SecondaryCol'>Project</h1>
          </div>
        </Link>
        <Link href='/portfolio/experience'>
          ...
          >
          <h1 className='text-4xl font-extrabold text-PrimaryCol  absolute left-10 top-10 group-hover:text-SecondaryCol'>Experince</h1>
          </div>
        </Link>
      </div>
    </section>
