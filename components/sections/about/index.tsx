...
export const AboutComponent = () => {
  let [ computerset , student]:any = about;
    return (
  <section className="col-span-12 grid grid-cols-12 gap-8 mt-20">
    <div className="col-span-12 md:col-span-4 flex flex-col items-center text-center px-4">
      <Image
        src={student.image}
        alt="Me"
        className="rounded-3xl object-cover shadow-xl w-72 md:w-full"
      />
      <h3 className={`${inter.className} mt-6 text-xl font-normal text-PrimaryCol`}>
        I graduated Senior High School last March of 2020
      </h3>
    </div>
    <div className={`${inter.className} col-span-12 md:col-span-8 bg-alterBG rounded-3xl shadow-xl p-8 md:p-12 flex flex-col gap-6`}>

      <div className={`${press.className} text-4xl md:text-6xl font-extrabold`}>
    ...
    <div className={`${inter.className} col-span-12 md:col-span-6 bg-avatarBG rounded-3xl shadow-xl p-8 flex flex-col gap-6`}>
