  ...
  return (
    <div className='w-auto h-screen flex flex-col text-center content-center gap-6'>
        <div className={`${poppins.className} text-left text-8xl font-extrabold w-5/6`}>
            ...
            <p className='text-ThirdCol text-lg leading-8 font-medium'>A self-motivated IT professional with knowledge and proficiency in JavaScript, HTML , CSS, and mobile responsive web development, as well as strong skills and ability in writing clean and efficient code.</p>
        </div>
